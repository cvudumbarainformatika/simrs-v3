    ...
    <div class="col full-height q-pa-md scroll">
      ...
      <div id="pdfDoc" class="bg-white relative-position">
        ...
        <AppKopSuratStandard :dataHeader="dataHeader" :pasien="pasien"
          :header="['ASESSMENT FISIOTERAPIS', 'FISIOTERAPI', '']" />
        <q-separator style="padding-bottom: 2px;" color="black"></q-separator>
        <div class="text-center q-py-sm text-bold">Lembar Program Terapi / Pendampingan Sebelum dan Sesudah Sesi
          Rehabilitasi</div>
        ...
        <div class="section" style="margin-top: -25px;">
          ...
          <div class="section">
            ...
            <div class="q-ml-md q-mb-sm"> {{ asessmentFisio?.subjective ?? '.........' }} </div>
            <div class="section-title text-italic" style=" margin-bottom: -2px;">Objective</div>
            <div class="q-ml-md q-mb-sm"> {{ asessmentFisio?.objective ?? '.........' }} </div>
            <div class="section-title text-italic" style=" margin-bottom: -2px;">Assessment</div>
            <div class="q-ml-md q-mb-sm"> {{ asessmentFisio?.asessment ?? '.........' }} </div>
            <div class="section-title text-italic" style=" margin-bottom: -2px;">Planning</div>


            <div class="section-title text-italic" style=" margin-bottom: -2px;">Procedure</div>
            <div class="q-ml-md q-mb-sm "> {{ asessmentFisio?.procedure ?? '.........' }} </div>
          </div>
        ...
        <div class="full-width row justify-between">
          ...
          <div class="col-auto" style="width: 300px; margin-left: 0; text-align: center;">
            ...
            <div style="margin-top: 10px; font-weight: 500;">
              {{ asessmentFisio?.petugas?.nama ?? '.........' }}
            </div>

          </div>

          <!-- TTD FISIOTERAPI -->
          <div class="col-auto q-mt-xl" style="width: 300px; margin-left: auto; text-align: center;">


            <!-- QR -->
            <div style="display: flex; justify-content: center; margin: 10px 0;">
              <div style="width: 90px;">
                <vue-qrcode :value="getQr(asessmentFisio?.petugas)" tag="svg" :options="{
                  errorCorrectionLevel: 'Q',
                  color: { dark: '#000000', light: '#ffffff' },
                  margin: 0
                }" />
