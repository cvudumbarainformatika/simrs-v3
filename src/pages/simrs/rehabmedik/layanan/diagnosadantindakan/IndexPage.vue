...
const tabsxx = [
  {
    label: 'Diagnosa Medik',
    name: 'diagnosa',
    icon: 'icon-my-stethoscope',
    comp: defineAsyncComponent(() => import('src/pages/simrs/poli/tindakan/comptindakan/pagemenu/complayanan/DiagnosaPage.vue'))
  },
  {
    label: 'Tindakan Medik',
    name: 'tindakan',
    icon: 'icon-mat-health_and_safety',
    comp: defineAsyncComponent(() => import('src/pages/simrs/poli/tindakan/comptindakan/pagemenu/complayanan/TindakanPage.vue'))
  }
