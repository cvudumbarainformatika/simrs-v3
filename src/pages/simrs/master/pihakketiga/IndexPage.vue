      ...
      <q-card-section class="col-auto">
        <div class="full-width row justify-between items-center content-between">
          ...
          <div class="flex q-gutter-sm">
            ...
            <q-input v-model="store.params.q" placeholder="Cari Pihak Ketiga ..." dense outlined style="min-width:200px"
              debounce="800" :loading="store.loading" @update:model-value="store.search" standout="bg-yellow-3">
              <template #prepend>
                <q-icon name="icon-mat-search" />
              </template>
...
import { useMasterPihakketigaStore } from 'src/stores/simrs/master/pihakketiga/pihakketiga';
...
const store = useMasterPihakketigaStore()
onMounted(() => {
  store.getData()
})
