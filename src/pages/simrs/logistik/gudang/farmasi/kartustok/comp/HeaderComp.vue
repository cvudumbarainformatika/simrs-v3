  ...
  <div class="column">
    <div class="row justify-between items-center q-pa-sm bg-primary text-white">
      <div class="kiri row q-gutter-sm">
        <q-input v-model="store.params.q" outlined dark color="white" dense placeholder="Cari Obat ..." debounce="500"
          style="min-width: 200px;" @keyup.enter="store.goToPage(1)">
      ...
      <div class="kanan">
        <q-btn flat round icon="icon-my-file-excel" size="sm" padding="sm"
    ...
    <div>
      <q-list dark class="bg-dark" dense>
        <q-item>
          <q-item-section style="width:40%">
            Nama Obat
          </q-item-section>
          <q-item-section style="width:60%" side>
