  ...
  <q-card flat square bordered class="column full-height">
    ...
    <div class="col-grow">
      <div class="full-height">
        <q-scroll-area v-if="pasien?.diagnosa?.length" style="height:calc(100% - 1px)" class="bg-grey">
          <q-list separator class="bg-white">
            <transition-group name="list">
              <q-item v-for="(item, n) in pasien?.diagnosa" :key="n" class="list-move q-pa-none">
                <q-item-section class="q-px-md q-py-sm">
                  ...
                  <q-item-label lines="2" class="f-12" v-if="item?.rs11 !== ''">
                ...
                <q-item-section side top class="text-right q-py-sm" v-if="bisaEditHapus">
