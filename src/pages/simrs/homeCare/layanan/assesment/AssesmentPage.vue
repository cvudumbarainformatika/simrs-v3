  ...
  <div class="column full-height q-ma-sm" style="overflow: hidden;">
    <div class="column full-height">
      <div class="col-auto bg-red">
        <q-tabs v-model="tab" no-caps inline-label class=" bg-grey-4 shadow-2 text-grey-8" align="left" dense
...
const DiagnosaPage = defineAsyncComponent(() => import('src/pages/simrs/homeCare/layanan/assesment/diagnosa/DiagnosaPage.vue'))
const TindakanPage = defineAsyncComponent(() => import('src/pages/simrs/homeCare/layanan/assesment/tindakan/TindakanPage.vue'))
...
const storetindakan = useDiagnosaHomeCare()
const tab = ref('Diagnosa Medik')
const tabs = ref([
  'Diagnosa Medik',
  'Tindakan Medik',
