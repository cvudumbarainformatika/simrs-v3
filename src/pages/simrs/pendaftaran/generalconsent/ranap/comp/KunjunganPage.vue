<template>
  <q-page class="column full-height q-pa-sm">
    <div class="col-auto">
      <HeaderComp title="General Consent Ranap" subtitle="General Consent Pengunjung Rawat Inap" />
    </div>
    <div class="col bg-white full-width full-height relative-position" style="overflow: hidden;">
