<template>
  <div class="full-height column absolute" style="overflow: hidden; width: 96%;">

    <!-- Header -->
    <div class="row items-center q-pb-none bg-primary text-white q-pa-sm">
    ...
    <div class="q-pa-sm bg-white border-bottom-primary">
      ...
      <div class="q-mt-sm row q-gutter-xs scroll-x no-wrap">
        <q-btn dense no-caps unelevated :color="selectedClass === 'all' ? 'primary' : 'grey-3'"
          :text-color="selectedClass === 'all' ? 'white' : 'grey-8'" label="Semua Kelas" @click="selectedClass = 'all'"
          class="q-px-md" />
        <q-btn v-for="cls in uniqueClasses" :key="cls" dense no-caps unelevated
          :color="selectedClass === cls ? 'primary' : 'grey-3'" :text-color="selectedClass === cls ? 'white' : 'grey-8'"
          :label="cls" @click="selectedClass = cls" class="q-px-md" />
      </div>
    </div>
    ...
    <!-- Content -->
    <div class="col scroll bg-grey-2 q-pa-md">
