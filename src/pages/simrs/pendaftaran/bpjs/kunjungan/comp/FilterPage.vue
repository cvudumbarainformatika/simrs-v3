  ...
  <q-dialog position="right">
    <q-card style="width: 350px" class="full-height">
      ...
      <q-card-section class="row items-center no-wrap">
        ...
        <q-space />
        <div>
          <q-btn flat round icon="icon-mat-close" @click="emits('close')">
      ...
      <q-card-section>
        <div>
          ...
          <app-input-date :model="from" outlined label="dari tanggal" placeholder="tanggal" class="q-mb-sm"
            @set-model="(val) => from = val" />
          <app-input-date :model="to" outlined label="sampai tanggal" placeholder="tanggal" class="q-mb-sm"
        ...
        <div>
          ...
          <q-select v-model="txt" dense outlined :options="txts" label="status pasien" class="q-ml-sm" emit-value
            map-options />
        </div>
        <q-separator class="q-my-md" />
        <div>
          ...
          <q-input v-model="q" outlined dense placeholder="Cari Pasien ..." />
        </div>
        <q-separator class="q-my-md" />
        <div class="row q-col-gutter-sm">
          <div class="col">
            <app-btn class="full-width" label="Cari Data" @click="sendData" />
          </div>
          <div class="col">
            <app-btn class="full-width" label="Reset" color="negative" @click="resetFilter" />
          </div>
        </div>
      </q-card-section>
    </q-card>
