<template>
  ...
  <q-scroll-area style="height: calc(100vh - 56px);">
    <div v-if="props?.pasien?.anamnesekebidanan?.length <= 0 && props?.pasien?.anamnesis?.length <= 0">
    ...
    <div v-else class="q-pa-sm " style="padding-bottom: 108px;">
      <div id="printMe" class="q-pa-sm full-width bg-white">
        <KopDokumen :judul="props?.judul ?? 'LEMBAR SERAH TERIMA PASIEN ANTAR RUANGAN'" :pasien="props?.pasien"
          :jangantampil=false />
