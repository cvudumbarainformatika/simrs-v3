<template>
  <q-card flat square class="full-height">
    <div class="column full-height">
      ...
      <div class="col-grow">
        <q-scroll-area v-if="pasien?.pemeriksaanfisik?.length" style="height:calc(100% - 1px)">
          <q-card flat bordered square dark>
            <q-list separator>
              <transition-group name="list">
                <template v-for="(item, i) in pasien?.pemeriksaanfisik" :key="i">
                  <!-- NADI-->
                  ...
                  <div class="q-pa-sm flex items-center">
                    ...
                    <div class="q-gutter-sm">
                      <q-btn flat round size="sm" icon="icon-mat-edit" color="yellow" @click="editForm(item)">
                        <q-tooltip>
                          Edit Pemeriksaan ?
                        </q-tooltip>
                      </q-btn>
                  ...
                  <q-card flat dark square>
                    <q-slide-transition>
                      ...
                      <div>
                        <q-separator dark />
                        <q-list v-if="item.detailgambars?.length" separator dark>
                          <q-item v-for="(row, n) in item.detailgambars" :key="n">
                  ...
                  <q-separator color="grey" size="5px" />
                </template>
              </transition-group>
            </q-list>
          </q-card>
