          ...
          <template v-for="(val, key) in store.form.skreeninggizi?.form" :key="val">
            <q-card-section class="row">
              ...
              <div class="col-3 flex q-gutter-sm justify-end">
                <q-radio v-for="aa in store.formGizis?.find(x=>x.kode===key)?.values" :key="aa" dense v-model="store.form.skreeninggizi.form[key]" :val="aa" :label="aa?.text" @update:model-value="hitungSkorGizi" />
              </div>
            </q-card-section>
            <q-separator />
          </template>
        ...
        <q-card flat bordered>
          ...
          <template v-for="(val, key) in store.formKebidanan.skreeninggizi?.form" :key="val">
            <q-card-section class="row">
              ...
              <div class="col-3 flex q-gutter-sm justify-end">
                <q-radio v-for="aa in store.formGiziObgyns?.find(x=>x.kode===key)?.values" :key="aa" dense v-model="store.formKebidanan.skreeninggizi.form[key]" :val="aa" :label="aa?.text" @update:model-value="store.hitungSkorSgk" />
              </div>
            </q-card-section>
            <q-separator />
          </template>
          ...
          <template v-for="(val, key) in store.formNeoNatal.skreeninggizi?.form" :key="val">
            <q-card-section class="row">
              ...
              <div class="col-9 flex q-gutter-sm">
                <q-radio v-for="aa in store.formGiziNeonatals?.find(x=>x.kode===key)?.values" :key="aa" dense v-model="store.formNeoNatal.skreeninggizi.form[key]" :val="aa" :label="aa?.text" @update:model-value="store.hitungSkorSgn" />
              </div>
            </q-card-section>
            <q-separator />
          </template>
