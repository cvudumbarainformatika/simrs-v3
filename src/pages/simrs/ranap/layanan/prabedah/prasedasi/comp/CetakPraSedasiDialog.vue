          ...
          <table class="full-width table-tight">
            <tbody>
              <tr>
                ...
                <td width="20%">
                  <q-checkbox :model-value="kajianObj?.hilangnyaGigi === 'Ya'" size="xs" label="Ya" dense disable color="black" class="q-mr-sm" />
                  <q-checkbox :model-value="kajianObj?.hilangnyaGigi === 'Tidak'" size="xs" label="Tidak" dense disable color="black" />
                </td>
                <td width="30%">Muntah</td>
                <td width="20%">
                  <q-checkbox :model-value="kajianObj?.muntah === 'Ya'" size="xs" label="Ya" dense disable color="black" class="q-mr-sm" />
              ...
              <tr>
                ...
                <td>
                  <q-checkbox :model-value="kajianObj?.masalahMobilisasiLeher === 'Ya'" size="xs" label="Ya" dense disable color="black" class="q-mr-sm" />
                  <q-checkbox :model-value="kajianObj?.masalahMobilisasiLeher === 'Tidak'" size="xs" label="Tidak" dense disable color="black" />
                </td>
                <td>Pingsan</td>
                <td>
                  <q-checkbox :model-value="kajianObj?.pingsan === 'Ya'" size="xs" label="Ya" dense disable color="black" class="q-mr-sm" />
              ...
              <tr>
                <td>Leher Pendek</td>
                <td>
                  <q-checkbox :model-value="kajianObj?.leherPendek === 'Ya'" size="xs" label="Ya" dense disable color="black" class="q-mr-sm" />
                  <q-checkbox :model-value="kajianObj?.leherPendek === 'Tidak'" size="xs" label="Tidak" dense disable color="black" />
                </td>
                <td>Stroke</td>
                <td>
                  <q-checkbox :model-value="kajianObj?.stroke === 'Ya'" size="xs" label="Ya" dense disable color="black" class="q-mr-sm" />
              ...
              <tr>
                <td>Batuk</td>
                <td>
                  <q-checkbox :model-value="kajianObj?.batuk === 'Ya'" size="xs" label="Ya" dense disable color="black" class="q-mr-sm" />
                  <q-checkbox :model-value="kajianObj?.batuk === 'Tidak'" size="xs" label="Tidak" dense disable color="black" />
                </td>
                <td>Kejang</td>
                <td>
                  <q-checkbox :model-value="kajianObj?.kejang === 'Ya'" size="xs" label="Ya" dense disable color="black" class="q-mr-sm" />
              ...
              <tr>
                <td>Sesak Nafas</td>
                <td>
                  <q-checkbox :model-value="kajianObj?.sesakNafas === 'Ya'" size="xs" label="Ya" dense disable color="black" class="q-mr-sm" />
                  <q-checkbox :model-value="kajianObj?.sesakNafas === 'Tidak'" size="xs" label="Tidak" dense disable color="black" />
                </td>
                <td>Sedang Hamil</td>
                <td>
                  <q-checkbox :model-value="kajianObj?.sedangHamil === 'Ya'" size="xs" label="Ya" dense disable color="black" class="q-mr-sm" />
              ...
              <tr>
                ...
                <td>
                  <q-checkbox :model-value="kajianObj?.baruSajaInfeksi === 'Ya'" size="xs" label="Ya" dense disable color="black" class="q-mr-sm" />
                ...
                <td>
                  <q-checkbox :model-value="kajianObj?.kelainanTulangBelakang === 'Ya'" size="xs" label="Ya" dense disable color="black" class="q-mr-sm" />
              ...
              <tr>
                ...
                <td>
                  <q-checkbox :model-value="kajianObj?.saluranNafasSakitDada === 'Ya'" size="xs" label="Ya" dense disable color="black" class="q-mr-sm" />
                  <q-checkbox :model-value="kajianObj?.saluranNafasSakitDada === 'Tidak'" size="xs" label="Tidak" dense disable color="black" />
                </td>
                <td>Obesitas</td>
                <td>
                  <q-checkbox :model-value="kajianObj?.obesitas === 'Ya'" size="xs" label="Ya" dense disable color="black" class="q-mr-sm" />
              ...
              <tr>
                ...
                <td>
                  <q-checkbox :model-value="kajianObj?.denyutJantungTidakNormal === 'Ya'" size="xs" label="Ya" dense disable color="black" class="q-mr-sm" />
