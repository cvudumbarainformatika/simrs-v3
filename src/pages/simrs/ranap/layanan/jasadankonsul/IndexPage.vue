...
const tabsxx = [
  {
    ...
    nakes: ['1', '2', '3'],
    comp: defineAsyncComponent(() => import('./visitedankonsul/IndexPage.vue'))
  },
  {
    label: 'Jasa Keperawatan',
    name: 'jasaKeperawatan',
    icon: 'icon-mat-description',
    nakes: ['1', '2', '3'],
    comp: defineAsyncComponent(() => import('./jasakeperawatan/IndexPage.vue'))
  }
