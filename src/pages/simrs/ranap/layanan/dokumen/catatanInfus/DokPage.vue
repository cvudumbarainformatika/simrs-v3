<template>
  <div id="pdfDoc" class="bg-white print-page">
    ...
    <div v-else-if="store.items?.length === 0" class="full-height column flex-center" style="min-height: 400px;">
      <div class="full-height column flex-center">
        Belum Ada Data
      </div>
    </div>
      ...
      <div class="section">
        <table border="1" width="100%">
          ...
          <tbody v-for="item in store.items" :key="item.id">
            <template v-if="item?.flag.includes('5' || '3')">
              <tr>
                <td valign="top">
                  <div class="column flex-center">
