<template>
  <div class="fit column">
    ...
    <div class="col full-height q-pa-md scroll">
      <PagtPage id="pagt" ref="refResume" :pasien="pasien" :menu="menu" :data-header="dataHeader" />
    </div>
  </div>
</template>
...
const PagtPage = defineAsyncComponent(() => import('./PagtPage.vue'))

const refResume = ref()

const printObj = {
  id: 'pagt',
  popTitle: 'Dokumen Asessment Gizi'
}
