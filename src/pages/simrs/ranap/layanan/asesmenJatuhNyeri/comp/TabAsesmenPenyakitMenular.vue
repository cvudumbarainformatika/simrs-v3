...
function bukaEdit(item) {
  ...
  Object.assign(form, {
    ...
    status_diag: item.status_diag || '',
    lama_sejak: item.lama_sejak || '',
    tahu_penyakit: item.tahu_penyakit || '',
    sumber_info: item.sumber_info || '',
    info_jangka: item.info_jangka || '',
    durasi_pengobatan: item.durasi_pengobatan || '',
    pemeriksaan_rutin: item.pemeriksaan_rutin || '',
    tempat_rutin: item.tempat_rutin || '',
    cara_penularan: Array.isArray(item.cara_penularan) ? item.cara_penularan : [],
    ruang_isolasi: item.ruang_isolasi || '',
    ruang_isolasi_ket: item.ruang_isolasi_ket || '',
    rujuk_ke: item.rujuk_ke || '',
    pakai_apd: item.pakai_apd || '',
    apd: Array.isArray(item.apd) ? item.apd : [],
    penyakit_penyerta: item.penyakit_penyerta || '',
    ket_penyakit_penyerta: item.ket_penyakit_penyerta || '',
    
    b_tahu_penyakit: item.b_tahu_penyakit || '',
    b_sumber_info: item.b_sumber_info || '',
    b_info_jangka: item.b_info_jangka || '',
    b_durasi_pengobatan: item.b_durasi_pengobatan || '',
    b_pemeriksaan_rutin: item.b_pemeriksaan_rutin || '',
    b_tempat_rutin: item.b_tempat_rutin || '',
    b_dirawat_terpisah: item.b_dirawat_terpisah || '',
