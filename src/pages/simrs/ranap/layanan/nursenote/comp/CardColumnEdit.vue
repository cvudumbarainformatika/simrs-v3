<template>
  <q-form class="fit row" @submit="onSubmit">
        ...
        <q-card flat class="fit bg-white">
          <q-card-section class="q-pa-md">
            ...
            <div>
              ...
              <div class="q-ml-sm">
                <text-area-edit :model-value="item?.implementasi" @update:model-value="(val) => {
                  // console.log('val', val);
            ...
            <div>
              ...
              <!-- <div class="q-ml-sm"> {{ item?.reseps || '-' }}

                <q-popup-edit fit buttons v-model="item.reseps" :cover="true" class="" v-slot="scope">

                  <q-input type="textarea" rows="20" v-model="scope.value" autofocus :error="isErrInput"
                    label="Pemakaian Obat" :error-message="errMsg" @keyup.enter.stop />

                </q-popup-edit>

              </div> -->
              <div class="q-ml-sm">
                <text-area-edit :model-value="item?.pemakaianobat" @update:model-value="(val) => {
                  // console.log('val', val);
          ...
          <q-card-section class="q-pa-md">
            <div>
              ...
              <div class="q-ml-sm flex">
                ...
                <div class="flex items-center q-gutter-x-xs">
                  <text-edit style="max-width: 80px;" :model-value="item.pendarahan" type="number" @update:model-value="(val) => {
                    item.pendarahan = val
                  }" />
                  <div>ml</div>
                </div>
              ...
              <div class="q-ml-sm flex">
                ...
                <div class="flex items-center q-gutter-x-xs">
                  <text-edit style="max-width: 80px;" :model-value="item.produksigc" type="number" @update:model-value="(val) => {
                    item.produksigc = val
                  }" />
                  <div>ml</div>
                </div>
