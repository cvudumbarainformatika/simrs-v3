                  ...
                  <div class="row q-col-gutter-md">
                    ...
                    <div class="col-6">
                      <div class="row rapat-row">
                        <div class="col-4 text-weight-bold text-grey-8">
                          Nama
                        </div>
                      ...
                      <div class="row rapat-row">
                        ...
                        <div class="col row items-center">
                          <div>{{ pasien?.norm ?? "-" }}</div>
                          <q-badge class="q-ml-sm" color="primary" outline>{{
                            pasien?.kelamin ?? "-"
                            }}</q-badge>
                        </div>
                      </div>
            ...
            <div class="row no-wrap items-stretch">
              ...
              <div class="col-auto q-pa-xs flex flex-center">
                <div class="q-mb-xs" style="
                  ...
                  ">
                  <q-spinner-ios v-if="
                    storepembayaran.loadingbayar ||
                    storepembayaran.loadingpembayaran
...
const qrUrl = computed(() => {
  const qrvalue =
    storepembayaran.qrcode === "" ? "123456789" : storepembayaran.qrcode; // noreg
...
// console.log("prop", prop.getKwitansiTerbayar);
...
const btnbilling = ref([
  {
    ...
    page: markRaw(
      defineAsyncComponent(() =>
        import(
          "../../../../kasir/rajal/listkunjungan/comp/CetakRekapBilling.vue"
        )
      )
    ),
  },
