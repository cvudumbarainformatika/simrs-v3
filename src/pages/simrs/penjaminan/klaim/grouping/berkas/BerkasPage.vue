...
const documents = ref([
  ...
  //   color: 'primary',
  //   jenis: 'IndikRanap',
  //   label: 'Indikasi Masuk Ranap',
  //   value: 'Indikasi_Masuk_Ranap'
  // },
  // {
  //   icon: 'icon-mat-email',
  //   color: 'primary',
...
const comp = [
  ...
  // { nama: 'Indikasi_Masuk_Ranap', page: defineAsyncComponent(() => import('../../../../igd/layanan/dokumen/dokumenisi/inidakasimasuknicudaninter/indikasimasuknicudaninter.vue')) },
