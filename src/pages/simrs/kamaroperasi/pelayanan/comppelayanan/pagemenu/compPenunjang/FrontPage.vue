<template>
  <div class="row fit relative-position">
    <div class="absolute-top columm fit q-pa-xs" style="padding-bottom: 41px;">
      ...
      <div class="col-auto " style="height: calc(100vh - 100px); overflow-y: auto; ">
...
const darah = usePermintaanBankDarahStore()
const ranap = usePengunjungRanapStore()
...
onMounted(async () => {
  ...
  lab.getNota(props.pasien, false) // isRanap false
  darah.getMaster()
  try {
    ranap.getNakes()
  } catch (e) {
    ...
    darah.dokters = ranap?.nakes?.filter(x => x?.kdgroupnakes === '1') ?? []
    darah.perawats = ranap?.nakes?.filter(x => x?.kdgroupnakes === '2' || x?.kdgroupnakes === '3') ?? []
...
const tabsxx = [
  {
    ...
    nakes: ['1', '2', '3'],
    comp: defineAsyncComponent(() => import('src/pages/simrs/poli/tindakan/comptindakan/pagemenu/comppenunjang/PageLaborat.vue'))
  },
  {
    label: 'Radiologi',
    name: 'radiologi',
    ...
    nakes: ['1', '2', '3'],
    comp: defineAsyncComponent(() => import('src/pages/simrs/poli/tindakan/comptindakan/pagemenu/comppenunjang/PageRadiologi.vue'))
  },
  // {
  //   label: 'Fisio',
  //   name: 'fisioterapi',
  ...
  //   nakes: ['1', '2', '3'],
  //   comp: defineAsyncComponent(() => import('src/pages/simrs/ranap/layanan/penunjang/comp/fisio/IndexPage.vue'))
  // },
  // {
  //   label: 'Operasi',
  //   name: 'operasi',
  ...
  //   nakes: ['1', '2', '3'],
  //   comp: defineAsyncComponent(() => import('src/pages/simrs/ranap/layanan/penunjang/comp/operasi/IndexPage.vue'))
  // },
  // {
  //   label: 'Operasi IRD',
  //   name: 'operasiIrd',
  //   icon: 'icon-mat-bedroom_parent',
  //   nakes: ['1', '2', '3'],
  //   comp: defineAsyncComponent(() => import('src/pages/simrs/ranap/layanan/penunjang/comp/operasiIrd/IndexPage.vue'))
  // },
  {
    label: 'Bank Darah',
    name: 'bankDarah',
    ...
    nakes: ['1', '2', '3'],
    comp: defineAsyncComponent(() => import('src/pages/simrs/ranap/layanan/penunjang/comp/bankdarah/IndexPage.vue'))
  },
  // {
  //   label: 'Apheresis',
  //   name: 'apheresis',
  ...
  //   nakes: ['1', '2', '3'],
  //   comp: defineAsyncComponent(() => import('src/pages/simrs/ranap/layanan/penunjang/comp/apheresis/IndexPage.vue'))
  // },
  // {
  //   label: 'Cathlab',
  //   name: 'cathlab',
  ...
  //   nakes: ['1', '2', '3'],
  //   comp: defineAsyncComponent(() => import('src/pages/simrs/ranap/layanan/penunjang/comp/cathlab/IndexPage.vue'))
  // },
  // {
  //   label: 'Ambulan',
  //   name: 'ambulan',
  ...
  //   nakes: ['1', '2', '3'],
  //   comp: defineAsyncComponent(() => import('src/pages/simrs/ranap/layanan/penunjang/comp/ambulan/IndexPage.vue'))
  // },
  // {
  ...
  //   nakes: ['1', '2', '3'],
  //   comp: defineAsyncComponent(() => import('src/pages/simrs/ranap/layanan/penunjang/comp/perawatanJenazah/IndexPage.vue'))
  // },
  // {
  //   label: 'Oksigen',
  //   name: 'oksigen',
  ...
  // nakes: ['1', '2', '3'],
  //   comp: defineAsyncComponent(() => import('src/pages/simrs/ranap/layanan/penunjang/comp/oksigen/IndexPage.vue'))
  // },
  // {
  ...
  //   nakes: ['1', '2', '3'],
  //   comp: defineAsyncComponent(() => import('src/pages/simrs/ranap/layanan/penunjang/comp/penunjangLainnya/IndexPage.vue'))
  // }
