    ...
    <q-card flat bordered class="anesthesia-chart-container">
      ...
      <div class="chart-section upper-section">
        <div class="chart-wrapper">
          <apexchart type="scatter" height="250" :options="upperChartOptions" :series="upperSeries" />
        </div>
      </div>
      ...
      <div class="vital-signs-container flex no-wrap items-center q-mt-md">
        ...
        <div class="chart-wrapper flex-grow">
          <apexchart ref="chartWrapperRef" type="line" :options="lowerChartOptions" :series="lowerSeries"
            height="400px" />
        </div>
      </div>
    </q-card>
...
const logs = ref([
  { time: 0, td_sistolik: 100, td_diastolik: 81, nadi: 95, resp: 17, mulai_op: 25, obat: [], cairan: [], o2: null, n2o: null, halothan: null, isoflurane: null, sevoflurane: null },
  {
    time: 5, td_sistolik: 120, td_diastolik: 80, nadi: 105, resp: 16, obat: [
      { nama: 'Paracetamol', dosis: '2 mg', cara_masuk: 'IV' },
    ], cairan: [], o2: null, n2o: null, halothan: null, isoflurane: null, sevoflurane: null
  },
  { time: 10, td_sistolik: 110, td_diastolik: 75, nadi: null, resp: 18, obat: [], cairan: [], o2: null, n2o: 25, halothan: null, isoflurane: null, sevoflurane: null },
  { time: 15, td_sistolik: 115, td_diastolik: 82, nadi: 110, resp: 16, obat: [], cairan: [{ nama: 'Normal Saline', volume: '100 ml' }], o2: null, n2o: null, halothan: null, isoflurane: null, sevoflurane: null },
  { time: 20, td_sistolik: 115, td_diastolik: 82, nadi: 110, resp: 16, obat: [{ nama: 'Propopol', dosis: '5 mg', cara_masuk: 'IV' },], cairan: [], o2: null, n2o: null, halothan: null, isoflurane: null, sevoflurane: null },
  { time: 25, td_sistolik: 115, td_diastolik: 82, nadi: 110, resp: 16, intubasi: 20, obat: [], cairan: [], o2: null, n2o: null, halothan: 25, isoflurane: null, sevoflurane: null },
  { time: 30, td_sistolik: 115, td_diastolik: 82, nadi: 110, resp: 16, extubasi: 20, obat: [], cairan: [], o2: null, n2o: null, halothan: null, isoflurane: null, sevoflurane: null },
  { time: 35, td_sistolik: 115, td_diastolik: 82, nadi: 110, resp: 16, x_ana: 20, obat: [], cairan: [], o2: 25, n2o: null, halothan: null, isoflurane: null, sevoflurane: null },
  { time: 40, td_sistolik: 115, td_diastolik: 82, nadi: 110, resp: 16, eno_oro: 20, obat: [{ nama: 'Paracetamol', dosis: '2 mg', cara_masuk: 'IV' },], cairan: [], o2: null, n2o: null, halothan: null, isoflurane: 25, sevoflurane: null },
  { time: 45, td_sistolik: 115, td_diastolik: 82, nadi: 110, resp: 16, ass_resep: 20, obat: [], cairan: [], o2: null, n2o: null, halothan: null, isoflurane: null, sevoflurane: null },
  { time: 50, td_sistolik: 115, td_diastolik: 82, nadi: 110, resp: 16, selesai_op: 20, obat: [], cairan: [{ nama: 'Normal Saline', volume: '100 ml' }], o2: null, n2o: null, halothan: null, isoflurane: null, sevoflurane: 25 },
])
...
const lowerChartOptions = computed(() => ({
  ...
  // legend: {
  //   markers: {
  //     // Memberikan warna yang sama dengan simbol di grafik
  //     fillColors: ['#2E7D32', '#f44336', '#2196f3', '#ff9800'],
  //   }
  // },
  legend: {
    show: true,
...
const lowerSeries = computed(() => [
  { name: 'Sistolik', type: 'scatter', data: logs.value.map(l => ({ x: l.time, y: l.td_sistolik, originalValue: l.td_sistolik })) },
  { name: 'Diastolik', type: 'scatter', data: logs.value.map(l => ({ x: l.time, y: l.td_diastolik, originalValue: l.td_diastolik })) },
...
const upperChartOptions = computed(() => ({
  chart: {
    id: 'meds',
    group: 'anesthesia', // Sinkron dengan lower chart
    toolbar: { show: false },
