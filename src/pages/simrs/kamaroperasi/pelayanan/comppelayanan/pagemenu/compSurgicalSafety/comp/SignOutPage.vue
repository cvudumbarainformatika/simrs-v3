      ...
      <div class="full-height columm q-col-gutter-x-xs">
        ...
        <div class=" ">
          <div class="q-px-sm">
            ...
            <div class="row">
              <div class="col-12 text-center">Perawat Sirkuler</div>
            </div>
            <div class="row q-my-md">
              <div class="col-12 text-center ">
                <div class="column flex-center">
                  <div style="width: 100px;">
                    <vue-qrcode :value="qrUrl(store.form.perawat_sirkuler)" tag="svg" :options="{
            ...
            <div class="row">
              <div class="col-12 text-center">{{ getNakesNya(store.form.perawat_sirkuler)?.nama ?? 'belum dipilih' }}
              </div>
            </div>
