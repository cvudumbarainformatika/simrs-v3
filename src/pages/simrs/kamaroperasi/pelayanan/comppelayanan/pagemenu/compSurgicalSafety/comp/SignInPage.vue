          ...
          <div class="q-px-sm">
            ...
            <div class="row q-my-md">
              <div class="col-6 text-center ">
                <div class="column flex-center">
                  <div style="width: 100px;">
                    <vue-qrcode :value="qrUrl(store.form.dokter_anastesi)" tag="svg" :options="{
              ...
              <div class="col-6 text-center">
                <div class="column flex-center">
                  <div style="width: 100px;">
                    <vue-qrcode :value="qrUrl(store.form.penata_anastesi)" tag="svg" :options="{
                      errorCorrectionLevel: 'Q',
                      color: {
                        dark: '#000000',
                        light: '#ffffff',
            ...
            <div class="row">
              <div class="col-6 text-center">{{ getNakesNya(store.form.dokter_anastesi)?.nama ?? 'belum dipilih' }}
              </div>
              <div class="col-6 text-center">{{ getNakesNya(store.form.penata_anastesi)?.nama ?? 'belum dipilih' }}
              </div>
            </div>
