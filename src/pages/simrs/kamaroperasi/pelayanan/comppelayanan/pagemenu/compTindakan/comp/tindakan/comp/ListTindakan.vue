...
import { useTindakanKamarOperasiStore } from 'src/stores/simrs/kamaroperasi/assasement/tindakan'

const store = useTindakanKamarOperasiStore()
...
const filterredTableByTgl = computed(() => {
  ...
  // console.log('hr ini ', filterred, val, arr)
