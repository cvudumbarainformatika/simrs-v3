...
const title = computed(() => {
  if (page.path === '/anggaran/pergeseranperubahan/belanja/listdata') {
    return 'LIST PERGESERAN ANGGARAN PERUBAHAN'
  }
  ...
  // }
    ...
    return 'FORM PERGESERAN ANGGARAN PERUBAHAN'
  }
})

const subtitle = computed(() => {
  if (page.path === '/anggaran/pergeseranperubahan/belanja/listdata') {
    return 'List Data Pergeseran Anggaran Perubahan'
  }
  ...
  // }
    ...
    return 'Form Input Pergeseran Anggaran Perubahan'
  }
})
