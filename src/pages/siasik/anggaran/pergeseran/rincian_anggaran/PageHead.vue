<template>
  <div class="row items-center justify-between title-page q-mb-md">
    ...
    <div class="row items-center">
      <q-btn-group outline>
        <q-btn :outline="path !== '/anggaran/pergeseran/rinci/form'" glossy size="md" color="teal"
          label="Form Pergeseran" @click="goTo('/anggaran/pergeseran/rinci/form')" />
        <q-btn :outline="path !== '/anggaran/pergeseran/rinci/listdata'" glossy size="md" color="dark"
          label="List Pergeseran" @click="goTo('/anggaran/pergeseran/rinci/listdata')" />
