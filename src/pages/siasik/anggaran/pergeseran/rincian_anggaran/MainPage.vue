...
const title = computed(() => {
  if (page.path === '/anggaran/pergeseran/rinci/listdata') {
    return 'LIST PERGESERAN ANGGARAN'
  }
  ...
  // }
    ...
    return 'FORM PERGESERAN ANGGARAN'
  }
})

const subtitle = computed(() => {
  if (page.path === '/anggaran/pergeseran/rinci/listdata') {
    return 'List Data Pergeseran Anggaran'
  }
  ...
  // }
    ...
    return 'Form Input Pergeseran Anggaran'
  }
})
