<template>
    <div class="row full-width justify-center">
        <div class="q-pa-sm" style="width:15%">
            <app-autocomplete v-model="store.reqs.jenisrka" label="Pilih Jenis RKA" autocomplete="value"
                option-label="label" option-value="value" outlined :source="store.jenisrka" :disable="store.loading"
                :loading="store.loading" @update:model-value="(val) => {
        ...
        <div v-if="store.reqs.jenisrka === '2' || store.reqs.jenisrka === '3'" class="q-pa-sm" style="width:15%">
            <app-autocomplete v-model="store.reqs.verif_ke" label="Pilih Penetapan" autocomplete="verif_ke"
                option-label="label" option-value="verif_ke" outlined :source="store.penetapan_ke"
                :disable="store.loading" :loading="store.loading" @update:model-value="(val) => {
                    console.log('value', val)
                    store.datarka = []
                    store.datarkapergeseran = []
                    store.reqs.bidang = ''
        ...
        <div class="q-pa-sm" style="width:10%">
        ...
        <div class="q-pa-sm" style="width:25%">
            <app-autocomplete v-model="store.reqs.bidang" label="Pilih Bidang" autocomplete="bidang"
                option-label="bidang" option-value="kodebidang" outlined :source="store.bidangs"
                :disable="store.loading" :loading="store.loading" @selected="(val) => {
                    store.datarkapergeseran = []
    ...
    <div class="row full-width justify-center">
        ...
        <div class="q-pa-sm">
            <q-btn icon="icon-mat-print" color="orange" round size="sm" :disable="store.loading"
                :loading="store.loading" @click="cetakData()">
...
function ambilData() {
    ...
    // console.log('ambil Data', store.reqs)
