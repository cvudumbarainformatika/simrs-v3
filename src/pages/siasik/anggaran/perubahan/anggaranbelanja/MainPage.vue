...
const title = computed(() => {
  if (page.path === '/anggaran/perubahan/belanja/listdata') {
    return 'LIST PERUBAHAN ANGGARAN'
  }
  ...
  // }
    ...
    return 'FORM PERUBAHAN ANGGARAN'
  }
})

const subtitle = computed(() => {
  if (page.path === '/anggaran/perubahan/belanja/listdata') {
    return 'List Data Perubahan'
  }
  ...
  // }
    ...
    return 'Form Input Perubahan Anggaran'
  }
})
