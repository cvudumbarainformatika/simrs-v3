                      ...
                      <table class="full-width">
                        ...
                        <tbody>
                          <tr style="height: 25px">
                            ...
                            <td>
                              {{ store.pergeseran.capaianprogramlama }}
                            </td>
                            <td class="text-right">
                              {{ store.pergeseran.targetcapaianlama }}
                            </td>
                            <td>
                              {{ store.pergeseran.capaianprogrambaru }}
                            </td>
                            <td class="text-right">
                              {{ store.pergeseran.targetcapaianbaru }}
                            </td>
                          </tr>
                          <tr style="height: 25px">
                            <td class="text-bold">
                            ...
                            <td>
                              {{ store.pergeseran.masukanlama }}
                            </td>
                            <td class="text-right">
                              {{ formatRpDouble(store.pergeseran.pagu) }}
                            </td>
                            <td>
                              {{ store.pergeseran.masukanbaru }}
                            </td>
                            <td class="text-right">
                              {{ formatRpDouble(store.pergeseran.pagubaru) }}
                            </td>
                          </tr>
                          <tr style="height: 25px">
                            <td class="text-bold">
                          ...
                          <tr style="height: 25px">
                            ...
                            <td>
                              {{ store.pergeseran.hasillama }}
                            </td>
                            <td class="text-right">
                              {{ store.pergeseran.targethasillama }}
                            </td>
                            <td>
                              {{ store.pergeseran.hasilbaru }}
                            </td>
                            <td class="text-right">
                              {{ store.pergeseran.targethasilbaru }}
                            </td>
                          </tr>
                        </tbody>
                      </table>
