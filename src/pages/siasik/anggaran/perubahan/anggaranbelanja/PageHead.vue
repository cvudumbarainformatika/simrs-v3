<template>
  <div class="row items-center justify-between title-page q-mb-md">
    ...
    <div class="row items-center">
      <q-btn-group outline>
        <q-btn :outline="path !== '/anggaran/perubahan/belanja/form'" glossy size="md" color="teal"
          label="Form Perubahan" @click="goTo('/anggaran/perubahan/belanja/form')" />
        <q-btn :outline="path !== '/anggaran/perubahan/belanja/listdata'" glossy size="md" color="dark"
          label="List Perubahan" @click="goTo('/anggaran/perubahan/belanja/listdata')" />
