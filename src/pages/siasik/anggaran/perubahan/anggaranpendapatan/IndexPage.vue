...
import { usePerubahanAnggaranPendapatanStore } from 'src/stores/siasik/anggaran/perubahan/anggaranpendapatan.js';
...
function Penetapan() {
  console.log('Penetapan', store.items, store.params.tahun)
