<template>
  <div class="row items-center justify-between title-page q-mb-md">
    ...
    <div class="row items-center">
      <q-btn-group outline>
        <q-btn :outline="path !== '/anggaran/penyusunan/prioritas/form'" glossy size="md" color="teal"
          label="Form Penyesuaian" @click="goTo('/anggaran/penyusunan/prioritas/form')" />
        <q-btn :outline="path !== '/anggaran/penyusunan/prioritas/listdata'" glossy size="md" color="dark"
          label="List Penyesuaian" @click="goTo('/anggaran/penyusunan/prioritas/listdata')" />
