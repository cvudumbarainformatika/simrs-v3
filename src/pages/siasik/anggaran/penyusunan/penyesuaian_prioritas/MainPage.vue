...
const title = computed(() => {
  if (page.path === '/anggaran/penyusunan/prioritas/listdata') {
    return 'LIST PENYESUAIAN PRIORITAS ANGGARAN'
  }
  ...
  // }
    ...
    return 'FORM PENYESUAIAN PRIORITAS ANGGARAN'
  }
})

const subtitle = computed(() => {
  if (page.path === '/anggaran/penyusunan/prioritas/listdata') {
    return 'List Data Penyesuaian Prioritas'
  }
  ...
  // }
    ...
    return 'Form Input Penyesuaian Prioritas Anggaran'
  }
})
