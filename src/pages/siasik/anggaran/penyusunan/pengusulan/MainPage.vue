...
const title = computed(() => {
  if (page.path === '/anggaran/penyusunan/pengusulan/listdata') {
    return 'LIST PENGUSULAN ANGGARAN'
  }
  ...
  // }
    ...
    return 'FORM PENGUSULAN ANGGARAN'
  }
})

const subtitle = computed(() => {
  if (page.path === '/anggaran/penyusunan/pengusulan/listdata') {
    return 'List Data Pengusulan'
  }
  ...
  // }
    ...
    return 'Form Input Pengusulan Anggaran'
  }
})
