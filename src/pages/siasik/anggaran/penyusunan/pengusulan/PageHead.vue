<template>
  <div class="row items-center justify-between title-page q-mb-md">
    ...
    <div class="row items-center">
      <q-btn-group outline>
        <q-btn :outline="path !== '/anggaran/penyusunan/pengusulan/form'" glossy size="md" color="teal"
          label="Form Pengusulan" @click="goTo('/anggaran/penyusunan/pengusulan/form')" />
        <q-btn :outline="path !== '/anggaran/penyusunan/pengusulan/listdata'" glossy size="md" color="dark"
          label="List Pengusulan" @click="goTo('/anggaran/penyusunan/pengusulan/listdata')" />
