    ...
    <div class="row">
      <div class="full-width">
        <q-markup-table flat-bordered wrap-cells :separator="separator">
          ...
          <!-- <tbody v-if="store.hasilRinci2.length">
            <tr v-for="it in store.hasilRinci2" :key="it">
              <td> {{ it.tanggal }} </td>
              <td> {{ it.notrans }} </td>
              <template v-if="!it.keterangan">
          ...
          <tbody v-if="store.hasilRinci3.length">
            <tr v-for="it in store.hasilRinci3" :key="it">
              <td> {{ it.tanggal }} </td>
              <td> {{ it.notrans }} </td>
              <template v-if="!it.keterangan">
          ...
          <tbody v-if="store.hasilRinci4.length">
            <tr v-for="it in store.hasilRinci4" :key="it">
              <td> {{ it.tanggal }} </td>
              <td> {{ it.notrans }} </td>
              <template v-if="!it.keterangan">
          ...
          <tbody v-if="store.hasilRinci5.length > 0">
            <tr v-for="it in store.hasilRinci5" :key="it">
              <td> {{ it.tanggal }} </td>
              <td> {{ it.notrans }} </td>
              <template v-if="!it.keterangan">
          ...
          <tbody v-if="store.hasilRinci6.length > 0">
            <tr v-for="it in store.hasilRinci6" :key="it">
              <td> {{ it.tanggal }} </td>
              <td> {{ it.notrans }} </td>
              <template v-if="!it.keterangan">
