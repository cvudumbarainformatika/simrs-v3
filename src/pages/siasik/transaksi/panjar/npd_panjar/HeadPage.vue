<template>
  <div class="row items-center justify-between title-page q-mb-md">
    ...
    <div class="row items-center">
      <q-btn-group outline>
        <q-btn :outline="path !== '/siasik/panjar/npdpanjar/formdata'" glossy size="md" color="teal"
          label="Form NPD-PANJAR" @click="goTo('/siasik/panjar/npdpanjar/formdata')" />
        <q-btn :outline="path !== '/siasik/panjar/npdpanjar/listdata'" glossy size="md" color="dark"
          label="List NPD-PANJAR" @click="goTo('/siasik/panjar/npdpanjar/listdata')" />
