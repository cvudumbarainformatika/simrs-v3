...
import PageHead from './HeadPage.vue'
...
const title = computed(() => {
  if (page.path === '/siasik/panjar/npdpanjar/listdata') {
    return 'LIST NPD-PANJAR'
  }
  ...
  // }
    ...
    return 'NEW FORM NPD-PANJAR'
  }
})

const subtitle = computed(() => {
  if (page.path === '/siasik/panjar/npdpanjar/listdata') {
    return 'List Data NPD-PANJAR'
  }
  ...
  // }
    ...
    return 'Form Input Pengajuan NPD-PANJAR'
  }
})
