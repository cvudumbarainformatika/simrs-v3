              ...
              <q-card-section class="q-py-sm q-px-md full-width">
                    ...
                    <tr>
                      ...
                      <td class="text-right">
                        <div class="row full-width justify-between">
                          ...
                          <div class="flex-end text-right">{{ formattanpaRp(store.cetaknotadinas.jumlahspp) }}</div>
                        </div>
                      </td>
                    </tr>
                    <tr>
                ...
                <div class="col-auto q-pt-sm text-bold">
                  <div class="row q-col-gutter-md full-width">
                    ...
                    <div class="col full-width">
                      <div class="q-py-xs">
                        : {{ 'Rp. ' + formattanpaRp(store.cetaknotadinas.jumlahspp) }}
                      </div>
                      <div>: {{ terbilangRupiah(store.cetaknotadinas.jumlahspp) + ' Rupiah' }} </div>
                    </div>
                  </div>
                </div>
