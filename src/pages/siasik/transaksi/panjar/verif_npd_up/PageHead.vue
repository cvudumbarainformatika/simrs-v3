<template>
  <div class="row items-center justify-between title-page q-mb-md">
    ...
    <div class="row items-center">
      <q-btn-group outline>
        <q-btn :outline="path !== '/siasik/panjar/verifup/listbelum'" glossy size="md" color="teal"
          label="Data Belum Verifikasi" @click="goTo('/siasik/panjar/verifup/listbelum')" />
        <q-btn :outline="path !== '/siasik/panjar/verifup/listsudah'" glossy size="md" color="dark"
          label="Data Terverifikasi" @click="goTo('/siasik/panjar/verifup/listsudah')" />
