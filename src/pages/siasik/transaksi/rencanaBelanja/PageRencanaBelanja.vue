...
import PageHead from './HeadRencanabelanja.vue'
...
const title = computed(() => {
  if (page.path === '/siasik/rencanabelanja/listdata') {
    return 'LIST PERENCANAAN BELANJA'
  }
  ...
  // }
    ...
    return 'FORM PERENCANAAN BELANJA'
  }
})

const subtitle = computed(() => {
  if (page.path === '/siasik/rencanabelanja/listdata') {
    return 'List Data Perencanaan Belanja'
  }
  ...
  // }
    ...
    return 'Form Input Perencanaan Belanja'
  }
})
