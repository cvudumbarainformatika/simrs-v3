...
const title = computed(() => {
  if (page.path === '/siasik/ls/serahterima/listserahterima') {
    return 'LIST SERAHTERIMA'
  }
  ...
  // }
    ...
    return 'FORM SERAHTERIMA'
  }
})

const subtitle = computed(() => {
  if (page.path === '/siasik/ls/serahterima/listserahterima') {
    return 'List Data Serahterima'
  }
