            ...
            <div class="col">
              ...
              <div class="row q-col-gutter-md q-pr-md q-pt-sm full-width">
                <div class="col text-justify text-wrap" style="line-height: 1.6;">
                  Menyatakan dengan sesungguhnya bahwa saya bertanggungjawab penuh atas pencairan dan penggunanan dana
                  pada :
                </div>
              </div>
              ...
              <div class="row q-col-gutter-md q-pr-md q-pt-sm full-width">
                <div class="col text-justify text-wrap" style="line-height: 1.6;">
                  ...
                  menerimanya. Apabila dikemudian hari, atas pencairan dan penggunaan dana diatas mengakibatkan kerugian
