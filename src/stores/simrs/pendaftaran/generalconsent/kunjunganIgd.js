...
export const useListKunjunganIgdStore = defineStore('list_kunjungan_igd-general_consent', {
  state: () => ({
    items: [],
    antrianBpjs: [],
    meta: null,
  ...
  actions: {
    ...
    async getListPasiens() {
      ...
      const resp = await api.post('/v1/simrs/pendaftaran/igd/kunjunganigdgeneralconsent', this.params)
      if (resp.status === 200) {
...
if (import.meta.hot) {
  import.meta.hot.accept(acceptHMRUpdate(useListKunjunganIgdStore, import.meta.hot))
}
