  ...
  actions: {
    ...
    getDiagnosaDropdown () {
      return new Promise(resolve => {
        api.get('v1/simrs/home-care/diagnosa/listdiagnosa')
          .then(resp => {
            if (resp.status === 200) {
    ...
    async simpanDiagnosa (pasien) {
      ...
      try {
        const resp = await api.post('v1/simrs/home-care/diagnosa/simpandiagnosa', form)
        // console.log(resp)
        if (resp.status === 200) {
    ...
    async deleteDiagnosa (pasien, id) {
      ...
      const resp = await api.post('v1/simrs/home-care/diagnosa/hapusdiagnosa', payload)
      if (resp.status === 200) {
        const storePasien = usePengunjungHomeCareStore()
        const storeIna = useInacbgPoli()
    ...
    editFormDiagnosa (val) {
      ...
      console.log('form', this.formdiagnosa)
      // console.log('xxx', val)
    },
...
if (import.meta.hot) {
  import.meta.hot.accept(acceptHMRUpdate(useDiagnosaHomeCare, import.meta.hot))
}
