...
export const usePembayaranKasirRajalStore = defineStore(
  "pembayaran-kasir-rajal-store",
  {
    state: () => ({
      loading: false,
    ...
    actions: {
      savePembayaran(pasien, subtotal, jenislayanan, val, router) {
        ...
        return new Promise((resolve) => {
          api
            .post("/v1/simrs/kasir/rajal/pembayarankarcis", this.form)
            .then((resp) => {
      ...
      async carikarcis(noreg) {
        ...
        const resp = await api
          .get("/v1/simrs/kasir/rajal/cari-karcis", params)
          .then((resp) => {
      ...
      async carikonsulantarpoli(noreg) {
        ...
        const params = { params: { noreg: noreg } };
        const resp = await api
          .get("/v1/simrs/kasir/rajal/carikonsulantarpoli", params)
          .then((resp) => {
      ...
      async cariobat(noreg) {
        ...
        const params = { params: { noreg: noreg } };
        const resp = await api
          .get("/v1/simrs/kasir/rajal/cari-obat", params)
          .then((resp) => {
            ...
            respdata.forEach((x) => {
              ...
              const rincianracik = (x?.rincianracik ?? []).reduce(
                (total, item) => {
                  const hargajual = item?.harga_jual ?? 0;
                  const jumlah = item?.jumlah ?? 0;
              ...
              const retur =
                x?.retur?.rinci?.reduce((total, item) => {
                  return (
                    total + (item.harga_jual ?? 0) * (item.jumlah_retur ?? 0)
                  );
                }, 0) ?? 0;
      ...
      async caritindakan(noreg) {
        ...
        const params = { params: { noreg: noreg } };
        const resp = await api
          .get("/v1/simrs/kasir/rajal/cari-tindakan", params)
          .then((resp) => {
      ...
      async caritindakanpsikologi(noreg) {
        ...
        const params = { params: { noreg: noreg } };
        const resp = await api
          .get("/v1/simrs/kasir/rajal/cari-tindakan-psikologi", params)
          .then((resp) => {
      ...
      async carioperasi(noreg) {
        ...
        const params = { params: { noreg: noreg } };
        const resp = await api
          .get("/v1/simrs/kasir/rajal/cari-tindakan-operasi", params)
          .then((resp) => {
      ...
      async carilaborat(noreg, x) {
        this.loadingbayar = true;
        this.itemslaborat = [];
        const params = { params: { noreg: noreg, jenislab: x } };
        const resp = await api
          .get("/v1/simrs/kasir/rajal/cari-laborat", params)
          .then((resp) => {
      ...
      async cariradiologi(noreg, x) {
        this.loadingbayar = true;
        this.itemsradiologi = [];
        const params = { params: { noreg: noreg, jenisrad: x } };
        const resp = await api
          .get("/v1/simrs/kasir/rajal/cari-radiologi", params)
          .then((resp) => {
      ...
      async carisharingbpjs(noreg) {
        ...
        const params = { params: { noreg: noreg } };
        const resp = await api
          .get("/v1/simrs/kasir/rajal/cari-sharingbpjs", params)
          .then((resp) => {
      ...
      savePembayarannonKarcis(pasien, nota, subtotal, jenis, router, x) {
        this.loadingpembayaran = true;
        this.form.noreg = pasien.noreg ?? nota;
        this.form.nota = nota;
        this.form.norm = pasien.norm ?? "-";
        this.form.tglkunjungan = pasien.tgl_kunjungan;
        this.form.nama = pasien.nama ?? "-";
        ...
        this.form.kodepoli = pasien.kodepoli;
        this.form.poli = pasien.poli;
        this.form.sistembayar = pasien.sistembayar ?? "UMUM";
        this.form.jenis = jenis;
        this.form.total = subtotal;
        return new Promise((resolve) => {
          api
            .post("/v1/simrs/kasir/rajal/pembayaran-non-karcis", this.form)
            .then((resp) => {
              this.loadingpembayaran = false;
